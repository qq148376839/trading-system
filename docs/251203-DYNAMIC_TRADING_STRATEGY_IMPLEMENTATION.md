...
**注意**: 回测功能尚未实现，详见 [回测功能实施计划](250101-BACKTEST_FEATURE_PLAN.md)
...
详见 [测试指南](251203-DYNAMIC_TRADING_STRATEGY_TESTING_GUIDE.md)
...
- [动态交易策略设计文档](251203-DYNAMIC_TRADING_STRATEGY_DESIGN.md)
- [策略Bug修复说明](251203-STRATEGY_BUG_FIX_20251203.md)
- [测试指南](251203-DYNAMIC_TRADING_STRATEGY_TESTING_GUIDE.md) ⭐
