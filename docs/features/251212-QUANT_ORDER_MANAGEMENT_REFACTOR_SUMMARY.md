...
- [完整PRD文档](251211-QUANT_ORDER_MANAGEMENT_REFACTOR_PRD.md)
- [实施完成总结](251211-QUANT_ORDER_MANAGEMENT_REFACTOR_IMPLEMENTATION_SUMMARY.md)
- [历史数据修复方案](251212-SIGNAL_ORDER_HISTORICAL_DATA_FIX.md)（可选）
