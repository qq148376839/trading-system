...
-- ============================================================================
-- 第十二部分：市场温度历史表（014_add_market_temperature_history.sql）
-- ============================================================================
...
COMMENT ON TABLE market_temperature_history IS '市场温度历史表，存储实盘 Longport API 真实温度，供回测读取';
COMMENT ON COLUMN market_temperature_history.timestamp IS '毫秒时间戳（5分钟窗口对齐）';
COMMENT ON COLUMN market_temperature_history.value IS '温度值 0-100';
...
-- ============================================================================
-- 第十四部分：期权交易K线存储 + 交易分析摘要（016_option_reverse_kline.sql）
-- ============================================================================
